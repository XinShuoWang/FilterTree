...
#ifndef YY_YY_FILTER_TAB_H_INCLUDED
# define YY_YY_FILTER_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 1
#endif
...
#endif /* !YY_YY_FILTER_TAB_H_INCLUDED  */
...
#line 52 "filter.y"
       {
            ...
            p->child_num_ = (yyvsp[-1].val)->child_num_;
            p->child_ = (yyvsp[-1].val)->child_;
            free((yyvsp[-1].val));
            (yyval.val) = p;
            INFO("and filter \n");
       }
